...
const productos = [
  { id: 1, nombre: "Hamaca de Hilo de Algodón", ciudad: "Masaya", precio: 1500, imagen: "https://images.unsplash.com/photo-1529253355930-ddc4ce242375?auto=format&fit=crop&w=800&q=80", descripcion: "Hamaca tradicional de doble puntada, tejida a mano en el barrio de Monimbó. Perfecta para exteriores e interiores, ofreciendo un descanso inigualable." },
  { id: 2, nombre: "Vasija de Cerámica Precolombina", ciudad: "Masaya", precio: 1200, imagen: "https://images.unsplash.com/photo-1610715936287-6c2420ebbfb1?auto=format&fit=crop&w=800&q=80", descripcion: "Elaborada en San Juan de Oriente utilizando técnicas ancestrales de cocción a leña y engobes naturales. Sus grabados cuentan historias de nuestros ancestros." },
  { id: 3, nombre: "Escultura en Marmolina", ciudad: "Estelí", precio: 850, imagen: "https://images.unsplash.com/photo-1601393166873-102573210b37?auto=format&fit=crop&w=800&q=80", descripcion: "Figura tallada a mano en piedra de marmolina de San Juan de Limay. Representa la vida campesina y la figura femenina con texturas increíblemente suaves." },
  { id: 4, nombre: "Garza de Madera de Balsa", ciudad: "Solentiname", precio: 450, imagen: "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?auto=format&fit=crop&w=800&q=80", descripcion: "Pieza de arte primitivista tallada en madera de balsa y pintada con colores vibrantes que reflejan la rica biodiversidad del archipiélago." },
  { id: 5, nombre: "Sombrero de Pita Fino", ciudad: "Camoapa", precio: 1800, imagen: "https://images.unsplash.com/photo-1580247817119-c6ca4f84f1cb?auto=format&fit=crop&w=800&q=80", descripcion: "Sombrero artesanal tejido finamente en cuevas para mantener la humedad de la fibra. Ligero, fresco, elegante y 100% biodegradable." },
  { id: 6, nombre: "Jícara de Filigrana Tallada", ciudad: "Rivas", precio: 600, imagen: "https://images.unsplash.com/photo-1584420493010-027f311c8286?auto=format&fit=crop&w=800&q=80", descripcion: "Jícara tradicional tallada a mano con técnica de filigrana. Una pieza decorativa que demuestra la paciencia y precisión de los artesanos del sur." },
  { id: 7, nombre: "Bolso de Cuero Repujado", ciudad: "Estelí", precio: 2200, imagen: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=800&q=80", descripcion: "Bolso de cuero 100% genuino, trabajado con técnicas de talabartería tradicional y repujado a mano con motivos florales." },
  { id: 8, nombre: "Tapiz Tejido en Telar", ciudad: "Masaya", precio: 1100, imagen: "https://images.unsplash.com/photo-1606905008063-6f142e057f81?auto=format&fit=crop&w=800&q=80", descripcion: "Tapiz decorativo tejido en telar de cintura con hilos de algodón teñidos naturalmente. Aporta calidez y textura a cualquier espacio." }
];
...
const artesanos = [
  { 
    ...
    imagen: "https://images.unsplash.com/photo-1533558701576-23c65e0272fb?auto=format&fit=crop&w=800&q=80",
    experiencia: "35 años",
  ...
  { 
    ...
    ciudad: "Masaya", 
    imagen: "https://images.unsplash.com/photo-1531834685032-c34bf0d84c77?auto=format&fit=crop&w=800&q=80",
  ...
  { 
    ...
    ciudad: "Camoapa", 
    imagen: "https://images.unsplash.com/photo-1605814566415-322122612260?auto=format&fit=crop&w=800&q=80",
    experiencia: "25 años",
  ...
  { 
    ...
    ciudad: "Estelí", 
    imagen: "https://images.unsplash.com/photo-1589758438368-0c53f165ab11?auto=format&fit=crop&w=800&q=80",
    experiencia: "15 años",
...
const talleres = [
  { id: 201, titulo: "Modelado en Barro y Engobes", categoria: "Cerámica", duracion: "4 Semanas", nivel: "Básico", precio: 600, imagen: "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?auto=format&fit=crop&w=800&q=80", instructor: "Taller Helio Gutiérrez", descripcion: "Aprende las técnicas milenarias de San Juan de Oriente. Desde la preparación del barro hasta el uso de engobes naturales para dar color a tus piezas sin químicos.", temario: ["Preparación de la arcilla", "Técnicas de modelado manual", "Aplicación de engobes", "Proceso de bruñido y horneado"] },
  { id: 202, titulo: "Tejido de Hamacas en Telar", categoria: "Textil", duracion: "6 Semanas", nivel: "Intermedio", precio: 800, imagen: "https://images.unsplash.com/photo-1528804431125-842f17de657b?auto=format&fit=crop&w=800&q=80", instructor: "Familia Suazo", descripcion: "Domina el arte del tejido de doble puntada característico de Masaya. Crea tu propia hamaca paso a paso con la guía de maestros tejedores.", temario: ["Uso del telar tradicional", "Técnica de doble puntada", "Elaboración de los brazos", "Acabados y flecos decorativos"] },
  { id: 203, titulo: "Talla y Pulido de Marmolina", categoria: "Piedra", duracion: "4 Semanas", nivel: "Básico", precio: 500, imagen: "https://images.unsplash.com/photo-1506804886642-19210089e144?auto=format&fit=crop&w=800&q=80", instructor: "Cooperativa de Limay", descripcion: "Descubre cómo transformar la rústica piedra de marmolina en esculturas de texturas increíblemente suaves, representando la vida cotidiana nicaragüense.", temario: ["Selección de la piedra", "Uso de herramientas de desbaste", "Técnicas de tallado", "Lijado y pulido final"] },
  { id: 204, titulo: "Pintura Primitivista en Madera", categoria: "Pintura", duracion: "3 Semanas", nivel: "Básico", precio: 450, imagen: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=800&q=80", instructor: "Taller de Arte Solentiname", descripcion: "Sumérgete en los colores vibrantes del archipiélago de Solentiname. Aprende a plasmar la flora y fauna local en piezas de madera de balsa.", temario: ["Preparación de la madera", "Bocetaje primitivista", "Teoría del color local", "Aplicación de acrílicos y sellado"] },
  { id: 205, titulo: "Extracción y Tejido de Pita", categoria: "Textil", duracion: "5 Semanas", nivel: "Avanzado", precio: 700, imagen: "https://images.unsplash.com/photo-1544644181-1484b3f6c680?auto=format&fit=crop&w=800&q=80", instructor: "Tejedoras de Camoapa", descripcion: "Un curso avanzado sobre el delicado proceso de tejer sombreros de pita. Conoce los secretos de la humedad y la tensión para lograr un tejido fino.", temario: ["Procesamiento de la fibra", "Inicio de la copa", "Tejido del ala", "Remate y planchado"] },
  { id: 206, titulo: "Repujado en Cuero Tradicional", categoria: "Cuero", duracion: "4 Semanas", nivel: "Intermedio", precio: 850, imagen: "https://images.unsplash.com/photo-1622396090075-ab5b2fce2d3f?auto=format&fit=crop&w=800&q=80", instructor: "Talabartería El Potro", descripcion: "Aprende las técnicas de la talabartería norteña. Desde el corte y preparación del cuero hasta el repujado de motivos florales y geométricos.", temario: ["Tipos de cuero y herramientas", "Trazado de diseños", "Técnicas de repujado", "Teñido y acabados"] }
];

const equipo = [
  { id: 1, nombre: "María del Pilar Bermúdez", rol: "Coordinadora (Ing. Industrial)", imagen: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&q=80" },
  ...
  { id: 3, nombre: "Amy Reneé López", rol: "Investigadora (Arquitectura)", imagen: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=300&q=80" },
  { id: 4, nombre: "Ángel Lenin Vivas", rol: "Desarrollador/diseñador (Ing. Computación)", imagen: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=300&q=80" },
